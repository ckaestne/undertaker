...
/*
 * check-name: CNF: Full text of kernel/rcupdate.c.c from Linux v2.6.37-rc1-542-g0143832
 * check-command: undertaker -v -j dead -m cnfmodels -i /dev/null $file
 * check-output-start
...
I: loaded cnf model for m68knommu
...
I: creating rcupdate_cnf.c.B4.kconfig.globally.dead
I: creating rcupdate_cnf.c.B5.kconfig.globally.undead
 * check-output-end
 */
